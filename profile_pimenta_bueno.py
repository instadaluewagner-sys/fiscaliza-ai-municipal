...
# --- Penalização contratual · fluxo processual real v2 ---
PENALIZACAO_CONTROLS = [
    {
        "id": "vinculo_contratacao",
        "label": "Instrumento da contratação — contrato, ARP ou instrumento equivalente",
        "responsible": "Unidade demandante / gestão da contratação",
        "nature": "Base documental para identificar a obrigação cuja possível inexecução será apurada",
        "criticality": "alta",
        "foundation": "Lei nº 14.133/2021 e instrumentos da contratação",
        "absence_action": "Conferir contrato, Ata de Registro de Preços, Nota de Empenho ou outro instrumento equivalente antes de definir a obrigação.",
    },
    {
        "id": "obrigacao_exigivel",
        "label": "Ordem, requisição, Nota de Empenho ou ato equivalente e ciência da empresa",
        "responsible": "Unidade demandante / gestão da contratação",
        "nature": "Demonstra que a obrigação foi efetivamente exigida da contratada",
        "criticality": "alta",
        "foundation": "Instrumentos da contratação, Termo de Referência, edital/ata e Lei nº 14.133/2021",
        "absence_action": "Conferir o ato que exigiu a execução e a prova de sua comunicação à empresa; não presumir mora sem ciência da obrigação.",
    },
    {
        "id": "prazo_execucao",
        "label": "Prazo de entrega / execução aplicável",
        "responsible": "Unidade demandante / gestão da contratação",
        "nature": "Marco temporal para avaliar atraso ou não execução",
        "criticality": "alta",
        "foundation": "Termo de Referência, edital, ata, contrato ou instrumento equivalente",
        "absence_action": "Localizar o prazo aplicável e seu termo inicial antes de qualificar atraso ou inadimplemento.",
    },
    {
        "id": "fato_inadimplemento",
        "label": "Evidência do possível descumprimento",
        "responsible": "Fiscalização / unidade responsável pela execução",
        "nature": "Registro objetivo do fato que motivou a apuração",
        "criticality": "alta",
        "foundation": "Lei nº 14.133/2021 e documentação de execução",
        "absence_action": "Exigir descrição objetiva do fato, período, obrigação descumprida e evidências correspondentes.",
    },
    {
        "id": "cobranca_previa",
        "label": "Cobranças ou notificações prévias da unidade responsável",
        "responsible": "Fiscalização / almoxarifado / unidade demandante",
        "nature": "Condicional — comunicação pré-sancionatória para entrega, regularização ou esclarecimentos",
        "criticality": "media",
        "foundation": "Instrumentos da contratação e rotina de gestão/fiscalização",
        "absence_action": "Quando houver tentativa de saneamento ou cobrança prévia, registrar separadamente; esta peça não substitui a Notificação Extrajudicial da Comissão de Penalização.",
    },
    {
        "id": "encaminhamento_comissao",
        "label": "Encaminhamento formal à Comissão de Penalização",
        "responsible": "Secretaria / unidade responsável pela contratação",
        "nature": "Remessa dos fatos e documentos para apuração sancionadora",
        "criticality": "alta",
        "foundation": "Decreto Regulamentar nº 405/2023 e fluxo administrativo municipal",
        "absence_action": "Conferir o documento que descreve os fatos e solicita a apuração pela Comissão.",
    },
    {
        "id": "instauracao",
        "label": "Abertura / autuação do processo de penalização",
        "responsible": "Unidade competente",
        "nature": "Formaliza a existência do processo específico de penalização",
        "criticality": "alta",
        "foundation": "Decreto Regulamentar nº 405/2023; Lei nº 14.133/2021",
        "absence_action": "Conferir o ato de abertura/autuação e o número próprio do processo de penalização.",
    },
    {
        "id": "designacao_comissao",
        "label": "Atribuição / designação à Comissão ou membro responsável",
        "responsible": "Presidência da Comissão / autoridade competente",
        "nature": "Identifica o responsável pela condução da fase processual",
        "criticality": "alta",
        "foundation": "Ato municipal de designação da Comissão e Decreto Regulamentar nº 405/2023",
        "absence_action": "Conferir competência, composição ou atribuição do processo antes da prática dos atos da Comissão.",
    },
    {
        "id": "notificacao_comissao",
        "label": "Notificação Extrajudicial da Comissão de Penalização",
        "responsible": "Comissão de Penalização",
        "nature": "Peça processual que dá ciência da apuração e abre oportunidade de defesa",
        "criticality": "alta",
        "foundation": "Lei nº 14.133/2021, arts. 155 a 163; Decreto Regulamentar nº 405/2023",
        "absence_action": "Se a Comissão já recebeu/assumiu o processo e não houver esta peça, indicar como próximo ato processual; notificações de cobrança anteriores não suprem este controle.",
    },
    {
        "id": "ciencia_notificacao_comissao",
        "label": "Comprovante de envio / recebimento da Notificação Extrajudicial da Comissão",
        "responsible": "Comissão de Penalização",
        "nature": "Comprova a ciência da empresa e permite controlar o prazo defensivo",
        "criticality": "alta",
        "foundation": "Contraditório e ampla defesa; Decreto Regulamentar nº 405/2023",
        "absence_action": "Conferir a prova de ciência antes de contar prazo ou tratar a defesa como intempestiva/ausente.",
    },
    {
        "id": "defesa_ou_decurso",
        "label": "Defesa administrativa ou certidão de decurso do prazo",
        "responsible": "Empresa / Comissão de Penalização",
        "nature": "Condicional — somente após ciência da Notificação Extrajudicial da Comissão",
        "criticality": "alta",
        "foundation": "Lei nº 14.133/2021 e Decreto Regulamentar nº 405/2023",
        "absence_action": "Sem Notificação Extrajudicial da Comissão, não apontar falta de defesa. Após a ciência, acompanhar o prazo e registrar defesa ou certidão de decurso.",
    },
    {
        "id": "instrucao_pos_defesa",
        "label": "Instrução após defesa / diligências / análise de provas",
        "responsible": "Comissão de Penalização e unidades consultadas",
        "nature": "Condicional — após defesa ou decurso do prazo",
        "criticality": "alta",
        "foundation": "Lei nº 14.133/2021; Decreto Regulamentar nº 405/2023",
        "absence_action": "Confrontar os argumentos defensivos com os documentos da execução e realizar diligências necessárias antes da conclusão.",
    },
    {
        "id": "relatorio_comissao",
        "label": "Relatório / manifestação conclusiva da Comissão",
        "responsible": "Comissão de Penalização",
        "nature": "Conclusão instrutória antes da decisão da autoridade competente, conforme o fluxo aplicável",
        "criticality": "alta",
        "foundation": "Decreto Regulamentar nº 405/2023 e fluxo municipal de responsabilização",
        "absence_action": "Conferir a manifestação conclusiva que enfrenta fatos, defesa, provas e eventual enquadramento.",
    },
    {
        "id": "decisao",
        "label": "Decisão administrativa motivada",
        "responsible": "Autoridade competente",
        "nature": "Julgamento do processo, sem automatização da conclusão pelo sistema",
        "criticality": "alta",
        "foundation": "Lei nº 14.133/2021; Decreto Regulamentar nº 405/2023",
        "absence_action": "Após a instrução, conferir decisão expressa, motivada e compatível com os fatos e a defesa.",
    },
    {
        "id": "ciencia_decisao",
        "label": "Ciência da empresa sobre a decisão",
        "responsible": "Unidade / Comissão responsável pela comunicação",
        "nature": "Marco para eventual fase recursal e cumprimento",
        "criticality": "alta",
        "foundation": "Lei nº 14.133/2021 e Decreto Regulamentar nº 405/2023",
        "absence_action": "Conferir prova de ciência da decisão antes de considerar encerrada a fase decisória.",
    },
    {
        "id": "recurso",
        "label": "Recurso / pedido de reconsideração, quando apresentado ou cabível",
        "responsible": "Empresa e autoridade competente",
        "nature": "Condicional — depende da decisão, da ciência e do exercício da via recursal",
        "criticality": "media",
        "foundation": "Lei nº 14.133/2021 e Decreto Regulamentar nº 405/2023",
        "absence_action": "Não apontar ausência automática de recurso; controlar o prazo e registrar recurso ou decurso quando aplicável.",
    },
    {
        "id": "encerramento",
        "label": "Registro, publicação, cumprimento e encerramento do processo",
        "responsible": "Unidade competente",
        "nature": "Condicional — após decisão definitiva ou encerramento da fase recursal",
        "criticality": "media",
        "foundation": "Lei nº 14.133/2021, regulamento municipal e rotinas de registro aplicáveis",
        "absence_action": "Conferir registros finais, cumprimento da decisão e encerramento somente quando a decisão estiver apta a produzir seus efeitos.",
    },
]
